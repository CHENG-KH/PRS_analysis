...
${pathway}Input/Script/bin/plink \
    ...
    --clump-r2 0.1 \
    --clump-kb 250 \
    --clump ${Outputbasedata}"$phenoarray"_216/finalBase.txt \
    --clump-snp-field SNP \
    --clump-field P \
...
awk '{print $2,$9}' ${Outputbasedata}"$phenoarray"_216/finalBase.txt > ${OutputPRS}$phenoarray/SNP.pvalue
${pathway}Input/Script/bin/plink \
    --bfile ${pathway}Output/TargetData/finalTarget \
    --score ${Outputbasedata}"$phenoarray"_216/finalBase.txt 2 4 11 header \
