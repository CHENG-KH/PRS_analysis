...
phenoarray=hypertension_216
merge_dir='/staging2/reserve/flagship/u3121714/kenny/Input/BaseData/hg38/hypertension/VCF_merge/'

#===========================================================
# Input case and contol txt
data=${pathway}Input/Laptop_input/hypertension_base.txt
...
${pathway}Input/Script/bin/plink --vcf process/indQC_nodup_chr_xym_"$phenoarray".vcf --pheno ${pathway}Input/Laptop_input/hypertension_base.txt --pheno-name $phenoarray --make-bed --out $phenoarray/"$phenoarray"_p
